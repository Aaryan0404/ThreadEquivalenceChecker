...
static int equiv_syscall_handler(regs_t *r) {
    ...
    case EQUIV_EXIT: 
        ...
        if(!th) {
            ...
            printk("starting next thread on queue %d\n", th->tid);
        }
